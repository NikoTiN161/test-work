    ...
    return (
        <Row className='align-items-center'>
            ...
            <Col>
                ...
                <svg style={{transform: `rotate(${props.windDeg}deg)`}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-up" viewBox="0 0 16 16">
